    ...
    Navigator.of(context).push(
      TransparentRoute(
        builder: (BuildContext context) => InfoDialogWidget(
          text: localizationUtil.translate("home", "notifications_options_dialog_text"),
...
final BackwardCompatibilityUtil backwardCompatibilityUtil = BackwardCompatibilityUtil();
